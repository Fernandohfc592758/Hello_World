...
public class MarcaController {
	...
	@GetMapping("/marcanome/{marcanome}")
	public ResponseEntity<List<Marca>> getByName(@PathVariable String marcanome ){
		return ResponseEntity.ok(repository.findAllByMarcanomeContainingIgnoreCase(marcanome) );
	}
